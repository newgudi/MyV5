...
<body>
	<div class="container">
		<div class="row">
			<div class="span12">				
				<div class="ulist">
					  用户列表		<a href="http://127.0.0.1/v5/member.php/User/adduser" class="btn btn-small btn-success pull-right">
					  ...
					  <table class="table table-striped">
					  	...
					  	<?php if(is_array($data)):?><?php  foreach($data as $k=>$v){ ?>
					  		<tr>
					  			...
					  			<td>
					  				<a href="http://127.0.0.1/v5/member.php/User/show/username/<?php echo $v['username'];?>" class="btn btn-small">修改</a>					  			
					  				<a href="http://127.0.0.1/v5/member.php/User/show/username/<?php echo $v['username'];?>" class="btn btn-small">查看</a>
					  			</td>					  			
					  		</tr>
					  	<?php }?><?php endif;?>
					  </table>
